    ...
    <main>
      <div class="row container pt-5 mt-3 informatica-banner">
        <div class="col-12 col-sm-6 i-3">
          <i class="fa-solid fa-network-wired icono-consultoria"></i>
        </div>
        <div class="col-12 col-sm-6 banner-consultoria">
          <div class="row">
            <div class="col-12 pb-4">
              <h2 class="h2-consultoria">Redes</h2>
            </div>
          </div>
          <div class="row">
            <div class="col-12 p-consultoria">
             <p><i class="fa-solid fa-check"></i> Redes Cableado Estructurado Voz, Datos y Video.</p>
             <p><i class="fa-solid fa-check"></i> Instalación y Mantenimiento de Sistemas de Comunicaciones.</p>
             <p><i class="fa-solid fa-check"></i> Radioenlaces inalámbricos.</p>
             <p><i class="fa-solid fa-check"></i> Video vigilancia IP CCTV.</p>
             <p><i class="fa-solid fa-check"></i> Centrales telefónicas.</p>
             <p><i class="fa-solid fa-check"></i> Mantenimiento Preventivo / Correctivo de Redes de Telecomunicaciones.</p>
             <p><i class="fa-solid fa-check"></i> Relevamientos y Auditorias.</p>
             <p><i class="fa-solid fa-check"></i> Modernización, Swaps y Desinstalación de equipamiento.</p>
             <p><i class="fa-solid fa-check"></i> Fibra Óptica, Tendido y Conexionado.</p>
             <p><i class="fa-solid fa-check"></i> Consultoría y Asesoramiento.</p>
            </div>
          </div>
        </div>
      </div>
