    ...
    <main>
      <div class="row container pt-5 mt-3 informatica-banner">
        <div class="col-12 col-sm-6 i-3">
          <i class="fa-solid fa-video icono-consultoria"></i>
        </div>
        <div class="col-12 col-sm-6 banner-consultoria">
          <div class="row">
            <div class="col-12 pb-4">
              <h2 class="h2-consultoria">Sistemas de observación</h2>
            </div>
          </div>
          <div class="row">
            <div class="col-12 p-consultoria">
             <p><i class="fa-solid fa-check"></i> Control de acceso y asistencia.</p>
             <p><i class="fa-solid fa-check"></i> Reconocimiento facial, biometría, proximidad, barreras vehiculares y molinetes.</p>
             <p><i class="fa-solid fa-check"></i> Visualización en tiempo real de su hogar, negocio o empresa.</p>
             <p><i class="fa-solid fa-check"></i> Grabación 24 horas en alta definición.</p>
             <p><i class="fa-solid fa-check"></i> Acceso remoto a través de dispositivos móviles y computadoras.</p>
            </div>
          </div>
        </div>
      </div>
